...
const Hero = () => {
  return (
    <div className="relative">
      ...
      <div className="container flex flex-col md:flex-row justify-end md:justify-between gap-4 items-center max-w-5xl h-[calc(100vh-50px)] md:h-[calc(100vh-56px)] overflow-hidden mt-12 md:mt-14">
        <div className="gap-4 md:basis-1/2 flex flex-col items-center md:items-start">
          <div className="text-blue-500 flex flex-col">
            <TextGenerateEffect
              words="Mazyar kawa"
              className="text-blue-500  font-extrabold md:text-8xl text-5xl"
            />
          </div>
